...
from imggen.triplet.tripletimggen import triplet_train_gen1,triplet_valid_gen1
from model.triplet.tripletnet1 import tripletnet
...
model=tripletnet(IMG_ROW,IMG_COL,modelfn)
model.summary()
...
train_pathdata,valid_pathdata,train_labeldata,valid_labeldata=train_test_split(pathdata,labeldata,
                                                                               test_size=0.1)
validdata=triplet_valid_gen1(BASE_DIR,IMG_ROW,IMG_COL,valid_pathdata,valid_labeldata)
history=model.fit_generator(triplet_train_gen1(BASE_DIR,IMG_ROW,IMG_COL,train_pathdata,train_labeldata,batch_size=30),
                            steps_per_epoch=100,
                            epochs=100,
